		...
		<div class="footer-top">
			<div class="container">
				...
				<div class="col-lg-4 col-md-6 footer-contact">
					<h3>OPUS Academy</h3>
					<p>
					<strong>Vancouver Location:</strong><br>
					5635 Dunbar Street, Vancouver, B.C. V6N 1W5<br>
					United States <br><br>
					<strong>Phone:</strong> (604) 267-3749<br>
					<strong>Fax:</strong> (604) 267-3748<br>
					<strong>Email:</strong> service@opusacademy.com<br>
					<strong>Wechat ID:</strong> opusacademy5635<br>
					</p>
				</div>

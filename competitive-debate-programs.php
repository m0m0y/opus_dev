...
<?php } if(isset($_GET["access_mca"])) { ?>
    ...
    <section class="partnership-slider secondary-bg">
        <div class="text-center mb-5">
            <h4 class="fw-bold slider-title">The Michigan College Alliance is the association of 14 premier Colleges & Universities in Michigan.</h4>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 pe-5">
                    <div class="section-title">
                        <h2 class="text-left mb-5 fw-bold">Who can take Access MCA programs?</h2>
                    </div>

                    <div class="d-flex justify-content-start">
                        <img src="assets/img/amichigan/access_mca.jpg" class="w-100" alt="awards-img" />
                    </div>

                    <div class="d-grid gap-2">
                        <a href="#!" type="button" class="danger-btn mt-4">Learn More</a>
                    </div>
                </div>

...
<?php } if(isset($_GET["access_mca"])) { ?>
               ...
               <div class="col-md-6 pe-5">
                ...
                <div class="col-md-6 text-content">
                    ...
                    <div class="mt-5">
                        ...
                        <a href="https://www.abetterwaytocollege.com/application">
                            ...
                            <div class=" ms-3 text-secondary fw-bold">
                                ...
                                <p><span class="fa-solid fa-circle green me-3"></span>Courses Start in September, January, and Summer</p>
                                <p><span class="fa-solid fa-circle green me-3"></span>Summer Residential Options Available</p>
                            </div>
                            <div class="text-secondary fw-bold ms-5">
                                <p><span class="fa-regular fa-circle borderr me-3"></span>Complete Coursework</p>
    ...
    <section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 pe-5">
                    <h2 class="text-left mb-3 fw-bold">The Standard Programs</h2>
                    <div class="d-flex justify-content-center">
                ...
                <div class="col-md-6 text-content">
                    <h4 class="fw-bold mt-5">The Standard Program equals the first year of college and prepares students to start as sophomores.</h4>
            ...
            <div class ="row m-5 justify-content-center">
                <div class ="col-md-8">
                    ...
                    <a class="btn btn-collapse p-4 w-100" data-bs-toggle="collapse" href="#BIO_160" role="button" aria-expanded="false" aria-controls="collapseExample"><h5 class ="fw-bold d-flex justify-content-start">BIO 160: Ecological and Evolutionary Systems (Environmental Science)</h5></a>
                        <div class="collapse" id="BIO_160">
                            <div class="card card-body mb-3">
                                <p>Students examine basic concepts in ecology and evolutionary biology to gain insights into adaptive features. Topics include: population genetics and ecology, evolutionary development and speciation, phylogenetics and genomics, adaptive biology, ecosystem dynamics, and biodiversity. Students develop critical thinking skills by applying those concepts to solve biological problems and learn scientific communication skills. Credits Awarded: 4.</p>
                            </div>
                        </div>
                        
                        <a class="btn btn-collapse p-4 w-100 mt-3" data-bs-toggle="collapse" href="#BIO_199" role="button" aria-expanded="false" aria-controls="collapseExample"><h5 class ="fw-bold d-flex justify-content-start">BIO 199: Neuroscience of Resilience</h5></a>
                        <div class="collapse" id="BIO_199">
                            <div class="card card-body mb-3">
                                <p>Building on two decades of research at the Mayo Clinic, this course explores neural traps and shows how transcending those traps can undo many of our brain’s vulnerabilities. Taking a neuroscience perspective, and grounded in empirical research, this course will explore topics such as the resilient mindset, gratitude, mindful presence, as well as the connections between resilience, behavior, and immune response. Students completing the course will have the option of completing the requirements for becoming a Certified Resilience Training (CeRT). Credits Awarded: 4.</p>
                            </div>
                        </div>

                        <a class="btn btn-collapse p-4 w-100 mt-3" data-bs-toggle="collapse" href="#BUS_121" role="button" aria-expanded="false" aria-controls="collapseExample"><h5 class ="fw-bold d-flex justify-content-start">BUS 121: Fundamentals of Investing</h5></a>
                        <div class="collapse" id="BUS_121">
                            <div class="card card-body mb-3">
                                <p>Topics include: the basic accounting principles used in different valuation techniques for valuing a public or private company; the relevant business principles used to evaluate comparative advantages of organic vs. merger and acquisition approach to growth; how to evaluate potential acquisition companies in terms of markets, customers, vendors, and potential efficiencies; how to determine the value of a company, using methods such as discounted cash flow, comparable sales, and net tangible assets minus liabilities.</p>
                            </div>
                        </div>

                        <a class="btn btn-collapse p-4 w-100 mt-3" data-bs-toggle="collapse" href="#ENG_315" role="button" aria-expanded="false" aria-controls="collapseExample"><h5 class ="fw-bold d-flex justify-content-start">ENG 315: Science, Technical, and Medical Writing</h5></a>
                        <div class="collapse" id="ENG_315">
                            <div class="card card-body mb-3">
                                <p>A study of writing in science, technology, and medical fields, with a focus on technical writing genres that may include academic research, journalism, data visualization, instructions, presentations, and/or grant writing. Students compose and revise documents relating to their own fields and interests, while examining how culture, ethics, inclusion, and accessibility factors influence technical writing.Credits Awarded: 4.</p>
                            </div>
                        </div>

                        <a class="btn btn-collapse p-4 w-100 mt-3" data-bs-toggle="collapse" href="#ENGR_150" role="button" aria-expanded="false" aria-controls="collapseExample"><h5 class ="fw-bold d-flex justify-content-start">ENGR 150: Introduction to Engineering</h5></a>
                        <div class="collapse" id="ENGR_150">
                            <div class="card card-body mb-3">
                                <p>This course introduces students to the basic principles of engineering and the various disciplines that constitute the field. Major engineering accomplishments are studied from historical, political, artistic and economic viewpoints. Students work in teams to solve engineering design problems and undertake laboratory investigations. Foundations of engineering science including force equilibrium, concepts of stress and strain, Ohm’s Law, and Kirchhoff ’s Voltage and Current Laws are studied. Credits Awarded: 4.</p>
                            </div>
                        </div>

                        <a class="btn btn-collapse p-4 w-100 mt-3" data-bs-toggle="collapse" href="#PHIL_201" role="button" aria-expanded="false" aria-controls="collapseExample"><h5 class ="fw-bold d-flex justify-content-start">PHIL 201: Introduction to Logic</h5></a>
                        <div class="collapse" id="PHIL_201">
                            <div class="card card-body mb-3">
                                <p>The study of the structure of reasoning. This course will introduce students to techniques for recognizing, formalizing, and evaluating the logical structures of arguments. Students will be taught symbolic languages, how to translate English arguments into those languages, and proof and testing procedures using the languages. This course will, along with introducing students to the rudiments of logic, explain how logic is employed in the articulation and solution of problems in various subdisciplines of philosophy. Credits Awarded: 4.</p>
                            </div>
                        </div>

                        <a class="btn btn-collapse p-4 w-100 mt-3" data-bs-toggle="collapse" href="#PSYC_100" role="button" aria-expanded="false" aria-controls="collapseExample"><h5 class ="fw-bold d-flex justify-content-start">PSYC 100: Introduction to Psychology</h5></a>
                        <div class="collapse" id="PSYC_100">
                            <div class="card card-body mb-3">
                                <p>An introduction to the science of behavior and mental life, ranging from biological foundations to social and cultural influences on behavior (introducing most of the content areas covered in other psychology courses). Research labs offer experimental and correlational hands-on experience that comprises the fourth credit. Credits Awarded: 3. A lab option can be taken for a fourth credit.</p>
                            </div>
                        </div>

                        <a class="btn btn-collapse p-4 w-100 mt-3" data-bs-toggle="collapse" href="#HIST_100" role="button" aria-expanded="false" aria-controls="collapseExample"><h5 class ="fw-bold d-flex justify-content-start">HIST 100:  Survey of US History</h5></a>
                        <div class="collapse" id="HIST_100">
                            <div class="card card-body mb-3">
                                <p>A survey of American history from the earliest moments through the modern period focusing on the ideas and ideals that have motivated and animated the American experiment.  By focusing on sources of conflict and common ground, the course allows students to delve into timeless and eternal questions regarding democracy, citizenship, essential freedoms, and the rule of law. Credits Awarded 3.</p>
                            </div>
                        </div>
                </div>
            </div>

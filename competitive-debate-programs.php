    ...
    <section id="section-container-mca" class="section-container">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-content">
                    <h4 class="fw-bold">The Standard Program equals the first year of college and prepares students to start as sophomores.</h4>
    ...
    <section class="secondary-bg">
        <div class ="container-fluid">
            <div class ="row justify-content-center">
                <h2 class="fw-bold text-center mb-5">Access MCA Scholars - Courses Offered Spring Term 2023</h2>

                <div class ="col-md-9">
                    <p>The following courses are available for individual enrollment.  Interested students should complete the individual course application.  All courses begin January 23, 2023.</p>

                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="min-width:100%;">
                        <tr>
                            <td style="background-color:#FFFFFF;color:#000000;padding:30px;">
                                <img alt="CleanSpace Logo" src=" width="130" style="display: block; margin: auto" />
                            </td>
                        </tr>
                    </table>
                            ...
                            <td style="padding:20px;">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" style="min-width:100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td valign="top" style="padding:5px; font-family: Arial,sans-serif; font-size: 16px; line-height:20px;">'.$email_address.'</td>
                                        </tr>
                                        <tr>

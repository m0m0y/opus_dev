...
$page = "mcgraw-hill-education-courses.php";
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">McGraw Hill Education Courses</h1>

                    <?php
                    if(isset($_GET["update"])) {

                        $id = $_GET["update"];
                        $mcGrawHillEducationContentWhere = $mcGrawHillEducation->getContentWhere($id);
                        ?>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3">
                                <div class="d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-sm fa-edit"></i> <?= $mcGrawHillEducationContentWhere["section"] ?>
                                        <span class="badge rounded-pill bg-secondary" style="color: white;"></span>
                                    </h6>

                                    <div class="d-sm-flex align-items-center justify-content-between">

                                        <a href="mcgraw_hill_education.php" class="btn btn-sm btn-secondary btn-icon-split">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-none">
                                    <input type="hidden" name="id" id="id" value="<?= $mcGrawHillEducationContentWhere["id"] ?>" class="form-control" readonly>
                                </div>

                                <div class="row mb-4">
                                    <label for="info_title" class="col-sm-2 col-form-label text-right"><span class="required">*</span> Title:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="title" id="title" value="<?= $mcGrawHillEducationContentWhere["title"] ?>" placeholder="Type Here...">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="page_content" id="page_content" class="form-control" required><?= $mcGrawHillEducationContentWhere['content'] ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" id="status" name="status">
                                            <option <?= ($mcGrawHillEducationContentWhere['status'] == 0 ? "selected" : "") ?> value="0">Enabled</option>
                                            <option  <?= ($mcGrawHillEducationContentWhere['status'] == 1 ? "selected" : "") ?> value="1">Disabled</option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3">
                                <div class="d-sm-flex align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Card Contents</h6>
                                </div>
                            </div>
                        ...
                        <?php
                        if(!empty($mcGrawHillEducationContent)) {
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-header py-3">
                                        <div class="d-sm-flex align-items-center justify-content-between">
                                            ...
                                            <a href="mcgraw_hill_education.php?update=<?= $id ?>" class="btn btn-sm btn-info btn-icon-split">
    ...
    <script src="services/mcgraw_hill_education.js"></script>

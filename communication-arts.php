...
<main id="main">
        ...
        <div class="container mt-5">
            ...
            <div class="row">
                ...
                <div class="col-md-6 px-5">
                    ...
                    <div class="d-flex justify-content-start">
                        <img src="assets/img/portfolio/p-26.JPG" class="w-100" alt="speak-img" />
                    </div>
    ...
    <section id="why-take-exam" class="why-take-exam section-bg">
        <div class ="container">
            <div class="row">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-content">
                    ...
                    <h2 class="fw-bold mt-3">Our well-designed curriculum includes:</h2>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-content">
                    ...
                    <p class="fs-4 fw-bold">Current Events </p>
                    ...
                    <p class="fs-4 fw-bold">Model United Nations</p>
                    ...
                    <p class="fs-4 fw-bold">Mock Trial</p>

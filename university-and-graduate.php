...
<main id="main">
    <section id="breadcrumbs" class="breadcrumbs py-3 px-5">
        <div class="container">
            ...
            <h2>University and Graduate School Counselling</h2>
        </div>
    </section>
    ...
    <div class ="container-fluid primary-bg">
        <div class="row">
            <div class="col-md-6 title-size">
                <h1 class="m-5 px-5 fw-bold">Our counsellors work with your family to assist you with your chosen school’s admission process.</h1><br>
    ...
    <section>
        <div class = "container">
            <div class="row">
                <div class="col-md-6">
                    <img src="assets/img/admin-counselling/university/catch-toga.jpg" class="w-100 mt-5" alt="happy-man">
                </div>

                <div class="col-md-6">
                    <h1 class="fw-bold title-size mt-5 mb-5">Lifelong Impact</h1>
                    <p class="mt-5 mb-5">University applications are arduous but ultimately reward the student with the career path of their choice. At Opus, we provide guidance throughout the entire application process. Our mission is to make sure that each applicant gets a chance to tell his or her story to the admission committee. We focus on not just the short-term, but the long-term success of the applicant. We believe in guiding the applicant to foster a passion and intellectual curiosity that will help them succeed in all their future endeavours.</p>
    ...
    <section>
        <div class="container mt-5">
           ...
           <p>We provide Admissions Counselling for the following:</p>
               ...
               <p> •	Business School Admissions </p>
               <p> •	Medical School Admissions</p>
               <p> •	Dental School Admissions </p>
   ...
   <section id ="" class="secondary-bg">
        <div class="container">
            ...
            <p class="text-center fw-bold mb-5">We are proud to have helped students admitted to the following top U.S. schools over the years:</p>
            ...
            <div class="row">   
                    ...
                    <div class="col-sm-3 my-5">
                        <div class="text-left mt-5 lh-base">
                            <ul class ="lh-lg">
